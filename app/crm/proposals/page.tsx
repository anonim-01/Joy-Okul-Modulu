...
import { Plus, ArrowLeft, FileText, Building2, DollarSign } from "lucide-react"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {proposals && proposals.length > 0 ? (
                ...
                <div className="flex flex-col gap-4">
                  <div className="flex-1">
                    ...
                    <div className="flex gap-2 mb-4 flex-wrap">
                      <Badge className="bg-orange-100 text-orange-700">{proposal.status}</Badge>
            ...
            <Card className="col-span-full p-12 text-center bg-white shadow-lg">
              ...
              <Button className="bg-blue-600 hover:bg-blue-700">Teklif Oluştur</Button>
            </Card>
          )}
        </div>
      </div>
