    ...
    <motion.header ref={headerRef} className="fixed top-0 left-0 right-0 z-50 p-4">
      <div className="container mx-auto flex justify-between items-center bg-black/20 backdrop-blur-md p-4 rounded-full">
        ...
        <nav className="hidden md:flex items-center gap-6 text-white">
          <TransitionLink href="/crm/schools" className="hover:text-neutral-300 transition-colors">
            CRM
          </TransitionLink>
          <TransitionLink href="/crm/reports" className="hover:text-neutral-300 transition-colors">
            Raporlar
          </TransitionLink>
          <TransitionLink href="/crm/admin" className="hover:text-neutral-300 transition-colors">
            Yönetim
          </TransitionLink>
        </nav>
        <TransitionLink href="/crm/schools">
          <motion.button
